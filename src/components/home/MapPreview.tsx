...
export function MapPreview() {
  return (
    <section id="map" className="relative mx-auto max-w-7xl px-5 py-16 sm:px-8">
      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-[rgba(168,85,247,0.18)] bg-[linear-gradient(135deg,rgba(28,20,48,0.58),rgba(6,6,10,0.74))] shadow-[0_30px_110px_rgba(0,0,0,0.48),0_0_70px_rgba(88,28,135,0.13)]">
        <div className="grid gap-0 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="p-7 sm:p-10">
            ...
            <h2 className="mt-3 font-display text-4xl font-semibold tracking-tight text-white">A travel-oriented atlas, without fake precision.</h2>
          ...
          <div className="relative min-h-[24rem] overflow-hidden border-t border-[rgba(168,85,247,0.14)] bg-[radial-gradient(circle_at_50%_50%,rgba(139,92,246,0.32),transparent_34%),radial-gradient(circle_at_66%_34%,rgba(190,50,134,0.12),transparent_32%),rgba(0,0,0,0.32)] lg:border-l lg:border-t-0">
